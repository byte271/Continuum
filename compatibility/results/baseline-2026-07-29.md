...
- Same-process resume passed: 32
- New-process resume matched CPython: 32
- Compatibility rate: 64.0%
...
| Diagnostic | Count |
| --- | ---: |
| `default parameters are unsupported` | 3 |
...
| `default_clamp_bounds` | failed | not_run | not_run | not_run | unsupported_language_or_runtime |
| `default_memo_fibonacci` | failed | not_run | not_run | not_run | unsupported_language_or_runtime |
| `default_parser_separator` | failed | not_run | not_run | not_run | unsupported_language_or_runtime |
